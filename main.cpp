...
void Menu_Screen() {
    ...
    Focus.createButton(Renderer, "anh/timerbutton.png", (SCREEN_WIDTH - 200) / 2, (SCREEN_HEIGHT - 300)/2, 200, 200);
    Training.createButton(Renderer, "anh/diagbutton.png", (SCREEN_WIDTH - 400) / 2, (SCREEN_HEIGHT)/2, 200, 200);
    Todo.createButton(Renderer, "anh/listbutton.png", SCREEN_WIDTH / 2, (SCREEN_HEIGHT)/2, 200, 200);
}
